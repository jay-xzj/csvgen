...
public class PomUtil {
     ...
     * @return
     */
    public static String getGroupId(File file){
        ...
        if(groupId==null) {
            ...
            groupId = absolutePath.substring(path.length() + 1).replaceAll("\\\\","\\.");
        }
    ...
    private static String resolveArtifactId(Model model) {
        String artifactId = model.getArtifactId();
    ...
    private static String getVersionWithELExpression(Model model, String key) {
        ...
        if (key.equalsIgnoreCase("project.version")) {
            ...
            if (pversion != null) {
                ...
                /*if (!version.equalsIgnoreCase(temp)){
                    return version;
                }else{
                    return null;
                }*/
    ...
    public static void main(String[] args) {
        ...
        String artifactId = getArtifactId(new File(gav));
    ...
    private static String combineParentPath(Model model) {
        ...
        if(parent != null) {
            ...
            String ga = groupId.replaceAll("\\.","\\\\") + "\\" + artifactId;
            result = path+"\\"+ga+"\\"+version+"\\"+artifactId+"-"+version+".pom";
        }
        return result;
    }
    ...
    public static List<List<Object>> extractData(File file,String type) {
        ...
        Model model = getPomModel(file);
        if (model != null) {
            String artifactId = PomUtil.getArtifactId(file);
            String groupId = PomUtil.getGroupId(file);
            String version = PomUtil.getVersion(file);
                ...
                try {
                    switch (type) {
                        case Constant.ARTIFACT_ALL:
                            List<List<Object>> subdatas1 = generateArtifactFile(version, artifactId, file, groupId, "");
                        ...
                        case Constant.DEPEND_ON_ALL:
                            List<List<Object>> subdatas2 = generateDependOnDatas(file, model, combination, "C:\\Users\\jayxu\\Desktop\\test\\" + Thread.currentThread().getId() + ".csv");
     ...
     * @throws Exception
     */
    private static List<List<Object>> generateDependOnDatas(File file, Model model, String acom, String fileName) throws Exception {
    ...
    private static String resolveVersion(Model model, String artifactId, String version) throws SQLException {
        if (version != null) {
            /*
            1. 直接有值直接拿
    ...
    public static List<List<Object>> generateArtifactFile(String version, String artifactId, File file, String groupId, String fileName) throws Exception {
